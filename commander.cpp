...
: Node("TBOT01_commander_node")
{
	...
	EVAL(room_initial);
	RCLCPP_INFO(this->get_logger(), "TBOT01 commander node has been initialised");
}

Commander::~Commander()
{
	RCLCPP_INFO(this->get_logger(), "TBOT01 commander node has been terminated");
}
